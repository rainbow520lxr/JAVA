...
public class Demo03 {
	public static void main(String[] args) {
		...
		try {
			...
			//通过反射API调用构造方法，构造对象
			User u = clazz.newInstance();	//其实是调用了User的无参构造方法  javaBean添加无参构造器
			System.out.println(u);
			
			Constructor<User> c = clazz.getDeclaredConstructor(int.class,int.class,String.class); //得到有参构造器
			...
			f.setAccessible(true); //这个属性不需要做安全检查了，可以直接访问  //私有属性可以设置
